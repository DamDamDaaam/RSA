...
set_property -dict { PACKAGE_PIN B9  IOSTANDARD LVCMOS33 } [get_ports {       del }]   ; #IO_L11N_T1_SRCC_16 Sch=btn[2]
set_property -dict { PACKAGE_PIN B8  IOSTANDARD LVCMOS33 } [get_ports {     start }]   ; #IO_L12P_T1_MRCC_16 Sch=btn[3]
